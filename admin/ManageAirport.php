                ...
                <div class="card mt-5">
                    <div class="card-header">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="search-container form-control d-flex align-items-center">
                                <i class="fas fa-search text-dark"></i>
                                <input id="airportid" class="search" placeholder="Tìm theo mã">
                            </div>
                            <div class="search-container form-control d-flex align-items-center">
                                <i class="fas fa-search text-dark"></i>
                                <input id="airportname" class="search" placeholder="Tìm theo tên">
                            </div>
                            <div class="search-container form-control d-flex align-items-center">
                                <i class="fas fa-search text-dark"></i>
                                <input id="cityname" class="search" placeholder="Tìm theo thành phố">
                            </div>
                            <div class="search-container form-control d-flex align-items-center">
                                <i class="fas fa-search text-dark"></i>
                                <input id="countryname" class="search" placeholder="Tìm theo quốc gia">
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
